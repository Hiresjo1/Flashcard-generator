...
const library = require("./cardsLibrary.json");
const BasicCard = require("./Basic.js")
const ClozeCard = require("./ClozeCards.js")
...
function shuffleDeck() {
    ...
    fs.writeFile("cardsLibrary.json", JSON.stringify(newDeck, null, 2)); //write the new randomized array over the old one
...
function showCards() {
    ...
    var library = require("./cardsLibrary.json");
